...
class Emailsvc extends CI_Controller{
    ...
    function contact_us(){
        ...
        $fromEmail = "webmaster@asovic.com";
        ...
        $mail->SetFrom('webmaster@asovic.com', 'noreply');  //Siapa yg mengirim email
        $mail->Subject    = $subject;
        $mail->Body       = $emailText;
        // $toEmail = "aswin@asovic.com"; // siapa yg menerima email ini
        // $toEmail = "marketing@asovic.com"; // siapa yg menerima email ini
